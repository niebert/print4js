...
<script nonce="v6dyPlRk4jpCy+OmgfdyUw==">
//<![CDATA[
...
<meta name="csrf-token" content="LNU1xwe5xjcet86h6LiV2m3ofb0K2+Z+vMeKPjiOm4eL8yJjLY63CHK73/nuFkuaH6TMkGw66qaKoC7SbC/xcQ==" />
<meta name="csp-nonce" content="v6dyPlRk4jpCy+OmgfdyUw==" />
...
<form class="new_user gl-show-field-errors" id="new_user" aria-live="assertive" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="KTfyMCOX/f7crsKQP6FRQmvjZJRY4Lf+heN5npGhnQKOEeWUCaCMwbCi08g5D48CGa/VuT4BuyazhN1yxQD39A==" /><div class="form-group">
...
<div class="login-body">
<form class="new_new_user gl-show-field-errors" id="new_new_user" aria-live="assertive" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="85AzlQdKqVqBuv8Xrei95pQTmlvKHumdE5PRvTZOLj5UtiQxLX3YZe227k+rRmOm5l8rdqz/5UUl9HVRYu9EyA==" /><div class="devise-errors">
